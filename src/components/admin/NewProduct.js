...
export default function NewProduct() {
        ...
        if (data.success) {
          setCategories(
            data.categories.map((cat) => {
              if (cat.isActive == true) return cat.name;
            })
          );
        }
      } catch (error) {
  ...
  return (
    <div className="admin-page-wrapper">
      ...
      <div className="admin-page-content">
        ...
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">Fill in the details to add a product</p>
          </div>
        </div>

        {/* ── Form Card ── */}
        <div className="np-form-shell">
          <form onSubmit={submitHandler} encType="multipart/form-data" noValidate>
      ...
      {/* ── Inline styles scoped to NewProduct ── */}
      <style>{`
        /* ── Form shell ── */
        .np-form-shell {
